...
\begin{figure}[H]
    ...
    \label{fig:myimage} % Sets a label for cross-referencing
\end{figure}
\[K := \lim_{\Delta s \to 0} \frac{\Delta \phi}{\Delta s} = \lim_{\Delta s \to 0} \frac{|\Delta \tau|}{|\bar \tau| \Delta s} = |\lim_{\Delta s \to 0} \frac{\Delta \bar \tau}{\Delta s} = \left|\frac{d \bar \tau}{ds}\right|\]
\[1 = ( \bar \tau(s), \bar \tau(s)),\]
\[
