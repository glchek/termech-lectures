...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \item
        Будем обозначать точки фазового пространства через $p$
    \end{itemize}
    \begin{enumerate}
        \item 
        ...
        \item
        $\varepsilon :< \Delta$, $E^* := \min_{\partial O_\varepsilon} E$
        \item
        ...
        если точка начинает движение из $O_\delta$, то она никогда не покинет $O_\varepsilon$, так как на границе $O_\varepsilon$ энергия не меньше $E^*$, а $E^{**} < E^*$
    \end{enumerate}
