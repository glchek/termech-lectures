...
\[\bar r = \bar r_{O'} + A r'\]
$\bar r'(t)$  $v$ - ? , $w$ - ?
\[\bar v = \dot{\bar r} = \frac{d}{dt}{\left(\bar r_{O'} + A \bar r \right)} = \bar v_{O'} + \dot A \bar r' + A \dot {\bar r}'  = \bar v_0 + \bar \omega \times (\bar r - \bar r_{O'}) + A \dot {\bar r}'\]
...
\[\bar \varepsilon = \bar \varepsilon_1 + \bar \omega_1 \times \bar \omega_2 + \bar \varepsilon_2 \qquad \dot A_1 \bar \omega_2' = \dot A_1 A_1^T A_1 \bar \omega_2' = \Omega \bar w_2' = \bar \omega_1 \times \bar \omega_2\]
