...
&= \frac{1}{\| \Lambda \|} ( \lambda \circ \vec \lambda \circ \lambda - \lambda \circ \vec \lambda \circ \vec \lambda + \vec \lambda \circ \vec \lambda \circ \lambda - \vec \lambda \circ \vec \lambda \circ \vec \lambda) = \frac{1}{\| \Lambda \|} (\lambda^2 \circ \vec \lambda - \vec \lambda \circ \vec \lambda \circ \vec \lambda) \\
&= \frac{(\lambda + \vec \lambda) \circ (\lambda - \vec \lambda) }{\| \Lambda \|} \circ \vec \lambda = \vec \lambda
\end{aligned}
\]
