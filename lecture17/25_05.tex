...
\Def Собственные частоты $\omega_1, \dots , \omega_n$ — числа:
\[\omega_i = \sqrt \lambda_i \quad i =1, \dots, n\]
где, $\lambda_i$ — корни многочлена $\det \left(C - \lambda A\right)$

\Def Собственная форма $\bar u_i$ — вектор:
\[\det(C - \lambda A) \bar u_i = 0\]
\end{document}