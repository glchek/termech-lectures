...
\begin{enumerate}
    ...
    \item $C = AB$ — матрица направляющих косинусов, если $A, B$ – матрицы направляющих косинусов
    \item существует группа поворотов
    \item $a_{ij}$ это их алгебраические дополнения
\end{enumerate}
\begin{proof}
    Замечание Глеба: всё это(кроме группы поворотов) было с доказательствами, но это всё есть в курсе линейной алгебры % fixme
\end{proof}
\end{document}