...
то есть величина силы зависит только от расстояния до начала координат и приложена по направлению радиус вектора(может быть противонаправлен при  отрицательном $F(r)$)
...
\section*{Аналитическая механика} %fixme chapter
...
\[0 = \sum_{k=1}^{N} (\bar F_k - m_k \bar w_k) \delta \bar r_k = 0 \sum_{k=1}^{N} (\bar F_k - m_k \bar w_k) \sum_{i=1}^{n} \frac{\partial \bar r_k}{\partial q_i} \delta q_i \]
