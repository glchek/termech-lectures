...
% fixme цитата
\noindent \keypoint Цитата Аксенова: Ньютон кстати может и не математик в первую очередь, он же глава королевского монетного двора, может он вообще в первую очередь был политиком, вы знали что Ньютон был трейдером: купил кучу акций Ост-Индской компании и потерял кучу денег
...
\begin{proof}
    ...
    \[\frac{d}{d t} \left(\frac{\partial f}{\partial t}\right) = \{\frac{\partial f}{\partial t}, H\} + \frac{\partial^2 f}{\partial t^2} = 0\]
\end{proof}
